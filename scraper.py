...
# Aziende su Greenhouse (board token nell'URL careers, es. .../airbnb)
GREENHOUSE_BOARDS = []      # es: ["coinbase", "kraken"]
# Aziende su Lever (slug nell'URL, es. jobs.lever.co/<slug>)
LEVER_COMPANIES = []        # es: ["binance"]

# Adzuna (consigliato: copre l'Italia E restituisce gli stipendi).
# Chiave gratuita su developer.adzuna.com.
ADZUNA_APP_ID = ""
ADZUNA_APP_KEY = ""
ADZUNA_COUNTRY = "gb"       # gb, it, us, de, fr, nl ...
ADZUNA_QUERIES = ["crypto compliance", "AML officer", "tax manager fintech",
                  "blockchain data analyst", "financial crime manager"]
...
SOURCES = [from_remotive, from_arbeitnow, from_jobicy, from_remoteok,
           from_himalayas, from_greenhouse, from_lever, from_adzuna]
